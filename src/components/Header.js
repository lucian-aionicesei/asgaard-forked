      ...
      <nav className="font-bold text-lg">
          ...
          <div className="text-concert-yellow px-8 py-3 h-26 flex items-end justify-between">
              <ul className="flex items-end space-x-12">
                  <li><Link to={"/"} className="text-xl"><span className="font-acier text-5.5xl font-extralight">Asgård</span><br/> FESTIVAL </Link></li>
                  <li><Link to={"/shop"} className="underline decoration-2 leading-8 underline-offset-4">Book</Link></li>
                  <li><Link to={"/lineup"} className="decoration-2 leading-8 underline-offset-4">Lineup</Link></li>
              </ul>
              <div className="flex items-center leading-8 space-x-12">
                  <Link to={"/shop"}>Buy Ticket</Link>
                  <Link to={"/purchases"}><MdOutlineShoppingCart /></Link>
              </div>
          </div>
      </nav>
