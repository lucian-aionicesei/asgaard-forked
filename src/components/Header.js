...
export default function Header() {
  return (
    <div className="w-full bg-black text-concert-yellow">
          ...
          <ul className="flex items-end space-x-12">
            <li>
              <Link to={"/"} className="text-xl">
                <span className="font-acier text-5.5xl font-extralight">Asgård</span>
                <br /> FESTIVAL{" "}
              </Link>
            </li>
            <li>
              <Link to={"/shop"} className="underline decoration-2 leading-8 underline-offset-4">
                Book
              </Link>
            </li>
            <li>
              <Link to={"/lineup"} className="decoration-2 leading-8 underline-offset-4">
                Lineup
              </Link>
            </li>
          </ul>
