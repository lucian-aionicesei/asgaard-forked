        ...
        <div>
          ...
          <div className="bg-concert-redish h-[10rem]">
            <div className="flex flex-row ">
              <div className=" bg-concert-yellow px-[0.3rem] py-[0.2rem] text-[9px] font-montserrat font-bold 2xl:px-[4.2rem] text-black mb-3 mt-2 mr-1">12 A.M - 02 P.M.</div>
              <div className="flex flex-row">
                <div className="font-montserrat font-extrabold text-black">SAD NIGHT DYNAMITE</div>
                <div>
                  <div className=" bg-concert-yellow  px-[0.3rem] py-[0.2rem] text-[9px] font-montserrat font-bold 2xl:px-[4.2rem] text-black mb-3 mt-2 mr-1">POP</div>
                </div>
                <div>
                  <img></img>
                </div>
